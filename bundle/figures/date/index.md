...
1. *An Introduction to Database Systems* (1975, 8th ed. 2003) — `paywalled`
2. *Databases, Types, and the Relational Model: The Third Manifesto* (1995, with Darwen) — `paywalled`
...
7. "What First Normal Form Really Means" (essay, various reprints) — `uncertain`
