...
1. "A Spiral Model of Software Development and Enhancement" (1988, IEEE Computer) — `public` (faculty.washington.edu mirror)
2. *Software Engineering Economics* (1981, book, introduces COCOMO) — `paywalled`
3. "Software Engineering" (1976, IEEE Trans. Computers survey) — `uncertain`
4. "A View of 20th and 21st Century Software Engineering" (2006, ICSE) — `uncertain`
5. *Software Cost Estimation with COCOMO II* (2000, book) — `paywalled`
