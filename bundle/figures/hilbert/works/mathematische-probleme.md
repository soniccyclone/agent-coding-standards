...
figure: hilbert
description: Hilbert's address to the 1900 International Congress of Mathematicians in Paris, laying out 23 open problems he saw as central to the field's future. The second problem, proving the consistency of the axioms of arithmetic, became a direct ancestor of the program that later produced Godel's incompleteness results and the Entscheidungsproblem. It set mathematics chasing foundational certainty in a way that computability theory grew directly out of.
...
**Venue/year:** Address to the 2nd International Congress of Mathematicians, Paris, August 1900; printed in Nachrichten von der Koniglichen Gesellschaft der Wissenschaften zu Gottingen (1900) and reprinted/translated widely since.
