...
1. "The Temporal Logic of Programs" (1977, FOCS) — `uncertain`
2. "The Temporal Logic of Reactive and Concurrent Systems: Specification" (1991, with Manna) — `paywalled`
3. "Temporal Verification of Reactive Systems: Safety" (1995, with Manna) — `paywalled`
4. "On the Synthesis of a Reactive Module" (1989, with Rosner) — `paywalled`
