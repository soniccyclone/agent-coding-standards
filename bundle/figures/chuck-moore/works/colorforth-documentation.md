---
type: work
title: "colorForth: Programming Language and Operating System"
figure: chuck-moore
description: Moore's own documentation for colorForth, his ground-up redesign of Forth around color-coded, pre-parsed source text instead of ordinary characters, built directly on the instruction set of his own Forth microprocessor chips rather than conforming to the ANS Forth standard. Functions as both language manual and OS documentation, since colorForth blurs that boundary the same way classic Forth systems did — the language, editor, and operating system are one artifact. Documentation-as-source-of-truth rather than a paper, consistent with how little Moore wrote up formally.
...
# colorForth: Programming Language and Operating System

**Venue/year:** Originally published on Moore's own colorforth.com; this page's content last updated October 2009.
