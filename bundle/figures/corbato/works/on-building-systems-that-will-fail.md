...
figure: corbato
description: Corbató's 1990 Turing Award lecture, arguing that "ambitious systems" — ones pushed to the edge of what's achievable — should be designed on the assumption that failure is a matter of when, not if. Draws on his experience with CTSS and Multics to argue for building in resilience and graceful degradation rather than chasing an unreachable standard of correctness. A rare case of a systems pioneer reflecting candidly on the limits of his own life's work rather than its triumphs.
...
**Venue/year:** 1990 ACM A.M. Turing Award lecture; published in Communications of the ACM 34(9), September 1991, pp. 72-81.
