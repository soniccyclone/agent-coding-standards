...
1. "Design and Synthesis of Synchronization Skeletons Using Branching Time Temporal Logic" (1981, with Clarke) — `public`
2. "Using Branching Time Temporal Logic to Synthesize Synchronization Skeletons" (1982, journal version) — `uncertain`
3. "Temporal and Modal Logic" (1990, Handbook of Theoretical CS) — `paywalled`
4. "Model Checking: Algorithmic Verification and Debugging" (2009, shared Turing lecture) — `public`
