...
figure: manna
description: Sorts temporal properties of reactive programs into a hierarchy (safety, guarantee, obligation, response, persistence, reactivity) built on the Borel classification of omega-regular languages, and supplies a matching proof rule for each class. The result is a proof system that covers every kind of temporal property a reactive program can have, not just the safety/liveness split earlier work had focused on. Co-written with Pnueli.
...
**Venue/year:** Theoretical Computer Science 83(1), 1991, pp. 97-130.
