...
All four verified public in Phase 3 and re-checked in Phase 4 (each returned HTTP 200, application/pdf):
...
2. "Interprétation fonctionnelle et élimination des coupures..." (1972 PhD thesis, introduces System F, in French) — `public` (self-archived on Girard's CNRS page)
3. "Linear Logic" (1987, Theoretical Computer Science) — `public` (self-archived on Girard's CNRS page; 102pp page scan, no text layer)
4. "The System F of Variable Types, Fifteen Years Later" (1986) — `public` (via the Wayback snapshot recorded in its work file)
