...
**Source:** https://worrydream.com/EarlyHistoryOfSmalltalk/ — live HTML transcription rehosted on Bret Victor's worrydream.com. Verified 200 OK. Carries the paper's running argument (printed pp. 1-41, introduction through the Coda) in full. It does NOT carry the references or Appendices I-V: the table of contents links to them but the page ends after the Coda's final paragraph. See the coverage note below.
