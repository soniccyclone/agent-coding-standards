...
1. "SEQUEL: A Structured English Query Language" (1974, with Chamberlin) — `paywalled`
2. Boyce-Codd Normal Form — originates from an unpublished IBM internal memo with Codd, 1974, later formalized in secondary literature (e.g. Date's textbooks) — `uncertain` (original memo not publicly archived)
