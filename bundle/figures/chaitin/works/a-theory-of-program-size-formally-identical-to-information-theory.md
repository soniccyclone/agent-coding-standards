...
figure: chaitin
description: The 1975 JACM paper that redefines program-size complexity using self-delimiting (prefix-free) programs, which makes the resulting measure obey the same subadditivity and conservation laws as Shannon entropy. This is the version of algorithmic complexity everything downstream actually depends on — including the halting probability Omega — since the original 1960s formulation lacked the formal properties needed to make that work. Effectively the paper that turns program-size complexity into a proper information theory rather than just a counting exercise.
...
**Venue/year:** Journal of the ACM 22(3), 1975, pp. 329-340.
