...
figure: chaitin
description: Constructs an exponential Diophantine equation whose number of integer solutions, as one parameter varies, is provably indistinguishable from a sequence of independent coin flips — encoding the bits of the halting probability Omega directly into ordinary arithmetic. Chaitin uses this to derive strong Godel-style incompleteness results from information/entropy arguments rather than self-reference. It's the clearest bridge in his output between abstract program-size theory and concrete number theory, resolving the "uncertain" flag from the earlier pass.
...
**Venue/year:** Advances in Applied Mathematics 8 (1987), pp. 119-146.
