...
figure: wilkes
description: Wilkes's 1967 Turing Award lecture, a retrospective on the two decades since the Moore School course launched the stored-program computer, covering EDSAC-era hardware, the rise of high-level languages and their formal syntax, and the arrival of time-sharing operating systems and CRT-based interactive computing. It closes with his assessment of where the field still had ground to cover. Not part of the original top-10 list but added here because it is Wilkes's best-known single document — the first ACM Turing Award lecture ever given — and a clearly public, clearly central source that surfaced while verifying the rest.
