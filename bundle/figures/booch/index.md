...
1. *Object-Oriented Analysis and Design with Applications* (1991/1994, book) — `paywalled`
2. *The Unified Modeling Language User Guide* (1998, with Rumbaugh, Jacobson) — `paywalled`
3. "Object Oriented Design" (1986, IEEE Software) — `uncertain`
4. *Handbook of Software Architecture* (ongoing) — `public` (Booch self-publishes at handbookofsoftwarearchitecture.com)
