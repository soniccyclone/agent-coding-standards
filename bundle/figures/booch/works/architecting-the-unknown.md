...
figure: booch
description: A SATURN 2016 keynote in which Booch argues that architecture's real job shows up when a system's requirements and environment can't be fully known in advance, not just when structuring a fully-specified design. He draws on decades of large-system case studies to argue for architectural decisions that stay resilient as unknowns resolve over a system's lifetime, rather than optimizing for a snapshot of requirements. The talk ties back to his long-running "Handbook of Software Architecture" project of codifying patterns across many real systems.
...
**Venue/year:** SATURN 2016 (Software Engineering Institute Architecture Technology User Network conference), Carnegie Mellon University Software Engineering Institute.
