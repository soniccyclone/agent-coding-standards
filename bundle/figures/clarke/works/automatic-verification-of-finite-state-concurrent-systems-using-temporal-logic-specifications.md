...
figure: clarke
description: The full journal treatment of the 1981 conference paper, co-authored with Emerson and A. Prasad Sistla. Formalizes CTL model checking as a decision procedure running in time linear in the size of the state graph and the formula, extends it to handle fairness constraints, and reports results from the EMC model checker running on real synchronization protocol and hardware examples. Turned model checking from a theoretical proposal into a demonstrated, implementable technique.
...
**Author(s):** Edmund M. Clarke, E. Allen Emerson, A. Prasad Sistla
**Venue/year:** ACM Transactions on Programming Languages and Systems 8(2), pp. 244-263, 1986. Originally presented at POPL 1983.
