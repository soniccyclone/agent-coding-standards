...
Publication list (~50 items) self-archived in full at web.mit.edu/Saltzer:
1. "End-to-End Arguments in System Design" (1984, with Reed, Clark, ACM TOCS) — `public` (web.mit.edu/saltzer/www/publications/endtoend/endtoend.pdf)
2. "The Protection of Information in Computer Systems" (1975, with Schroeder, Proc. IEEE) — `public` (self-archived, web.mit.edu/Saltzer)
3. "Protection and the Control of Information Sharing in Multics" (1974, CACM) — `public` (self-archived, part of full publication list)
4. Multics kernel design and process-switching documentation (1960s-70s, with the wider Multics team including Corbató) — `public` (multicians.org, overlaps with Corbató's entry)

Fewer than 10 individually verified in this pass — his page hosts the full list but only these were confirmed with specific accessible URLs; worth a fuller sweep in Phase 3.
