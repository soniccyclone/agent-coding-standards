...
1. "Specification and Verification of Concurrent Systems in CESAR" (1982, with Queille) — `uncertain`
2. "An Example of Specification and Verification in CESAR" (1985) — `uncertain`
3. "Property Preserving Abstractions for the Verification of Concurrent Systems" (1992, with Clarke, Grumberg, Long) — `paywalled`
