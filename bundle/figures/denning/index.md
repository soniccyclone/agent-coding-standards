...
1. "The Working Set Model for Program Behavior" (1968, CACM) — `public` (self-archived at denninginstitute.com)
2. "Virtual Memory" (1970, ACM Computing Surveys) — `uncertain`
3. "Thrashing: Its Causes and Prevention" (1968, with Kahn) — `uncertain`

Only the flagship paper confidently public.
