...
figure: landin
description: Landin argues that the ALGOL-family languages of the day are best understood as surface variants of a single underlying core, ISWIM, built on Church's lambda calculus plus a small set of imperative extensions. Rather than proposing one more language, the paper proposes a method — strip a language down to a tiny applicative kernel and treat everything else as notation defined on top of it. This "reduce syntax to semantic core" move became the standard way language designers and semanticists relate new languages to each other.
...
**Venue/year:** Communications of the ACM 9(3), March 1966, pp. 157-166.
