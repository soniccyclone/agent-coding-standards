...
- [What a reduction cannot derive from structure it silently borrows; keep a list of the properties you assumed twice](../lessons/what-a-reduction-cannot-derive-it-silently-borrows.md)
- [Whether a representation choice is invisible depends on what else the language admits; adding effects promotes it into a semantic decision](../lessons/whether-a-representation-choice-is-observable-depends-on-what-else-the-language-admits.md)
- [A total model answers questions the original left open and attaches checks that may never run; audit both its inventions and its idle guarantees](../lessons/a-model-answers-questions-you-never-asked.md)
