...
_**Pass 3 IN PROGRESS** (started at line 5774, §12). Plan: sequential sweep of 5774→11906, then 12784→16490, then 17000→17803, then 21269→21549. Current resume point: **line 6473**. This line is updated as the sweep advances; if this file is found with a resume point below 21549 and no `extraction: complete`, the sweep died and should be restarted from the recorded line._
