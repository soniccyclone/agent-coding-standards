...
1. "Software Development: A Rigorous Approach" (1980) — `paywalled`
2. "Systematic Software Development Using VDM" (1986/1990) — `paywalled` (controlled-lending copy on archive.org)
3. "Tentative Steps Toward a Development Method for Interfering Programs" (1983, TOPLAS, founding rely/guarantee paper) — `uncertain`
4. "Specification and Design of (Parallel) Programs" (1983, IFIP) — `uncertain`
